...
- (void)viewDidLoad {
	...
	region.center.latitude = 24.5568;
	region.center.longitude = -81.8018;
	...
	//SITE 1
	NSString *latitude =  @"24.556082";
	NSString *longitude = @"-81.803296";
	...
	annotation.mTitle=@"1. La Concha Hotel";
	annotation.mSubTitle=@"430 Duval Street";
	...
	annotation.mTitle=@"2. Key West Cemetery";
	annotation.mSubTitle=@"701 Passover Lane";
	...
	annotation.mTitle=@"3. Dean-Lopez Funeral Home";
	annotation.mSubTitle=@"418 Simonton Street";
	...
	annotation.mTitle=@"4. The Artist House";
	annotation.mSubTitle=@"534 Eaton Street";
	...
	annotation.mTitle=@"5. Key West Theater";
	annotation.mSubTitle=@"524 Eaton Street";
	...
	annotation.mTitle=@"6. St Paul's Church";
	annotation.mSubTitle=@"401 Duval Street";
	...
	annotation.mTitle=@"7. Hard Rock Cafe";
	annotation.mSubTitle=@"313 Duval Street";
	...
	annotation.mTitle=@"8. Sloppy Joe's";
	annotation.mSubTitle=@"201 Duval Street";
	...
	annotation.mTitle=@"9. Captain Tony's Saloon";
	annotation.mSubTitle=@"428 Greene Street";
