...
@interface PageNewViewController (ViewHandlingMethods)
- (void)prevController;
- (void)nextController;
...
@implementation PageNewViewController
...
-(void)loadAudioFile {
	...
	// Load the audio file
	if(player == nil){
		NSString *audioFile = [NSString stringWithFormat:@"nolacnew"];
