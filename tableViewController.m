...
#import "PageNewViewController.h"
...
- (void)viewDidLoad {
	...
	NSDictionary *row1 = [[NSDictionary alloc] initWithObjectsAndKeys:@"1. La Concha Hotel", @"Name", @"430 Duval Street",@"Address",@"nolactable1",@"Image", nil];
	NSDictionary *row2 = [[NSDictionary alloc] initWithObjectsAndKeys:@"2. Key West Cemetery", @"Name", @"701 Passover Lane",@"Address",@"nolactablenew",@"Image",  nil];
    NSDictionary *row3 = [[NSDictionary alloc] initWithObjectsAndKeys:@"3. Dean-Lopez Funeral Home", @"Name", @"418 Simonton Street",@"Address",@"nolactable2",@"Image",  nil];
	NSDictionary *row4 = [[NSDictionary alloc] initWithObjectsAndKeys:@"4. The Artist House", @"Name", @"534 Eaton Street",@"Address",@"nolactable3",@"Image",  nil];
	NSDictionary *row5 = [[NSDictionary alloc] initWithObjectsAndKeys:@"5. Key West Theater", @"Name", @"524 Eaton Street",@"Address",@"nolactable4",@"Image",  nil];
	NSDictionary *row6 = [[NSDictionary alloc] initWithObjectsAndKeys:@"6. St Paul's Church", @"Name", @"401 Duval Street",@"Address",@"nolactable5",@"Image",  nil];
	NSDictionary *row7 = [[NSDictionary alloc] initWithObjectsAndKeys:@"7. Hard Rock Cafe", @"Name", @"313 Duval Street",@"Address",@"nolactable6",@"Image",  nil];
	NSDictionary *row8 = [[NSDictionary alloc] initWithObjectsAndKeys:@"8. Sloppy Joe's", @"Name", @"201 Duval Street",@"Address",@"nolactable7",@"Image",  nil];
	NSDictionary *row9 = [[NSDictionary alloc] initWithObjectsAndKeys:@"9. Captain Tony's Saloon", @"Name", @"428 Greene Street",@"Address",@"nolactable8",@"Image",  nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (selectedSite == 2){
		...
		NSString *viewControllerName = @"PageNewViewController";
		childController = (PageOneViewController *)[[PageNewViewController alloc] initWithNibName:viewControllerName bundle:nil];
	}
	if (selectedSite == 3){
