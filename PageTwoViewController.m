...
- (void)viewDidLoad
{
	...
	[scrollView setContentSize:CGSizeMake(320, 3144)];
...
- (void) prevController {
	...
	PageNewViewController *pagenewVC = [[PageNewViewController alloc] initWithNibName: @"PageNewViewController" bundle:nil];
	...
	pagenewVC.hidesBottomBarWhenPushed = YES;
	[navigationStack addObject:pagenewVC];
